// lib/ghoku/index.ts
// ┌─────────────────────────────────────────────────┐
// │  Gh.O.K.U. — Background AI Agent                │
// │  Generative Heuristic Operational Knowledge Unit │
// │                                                  │
 ...
 *
 * GhOKU picks the best model, enhances the prompt, handles retries/fallbacks,
 * and records the result for future optimization.
 *
 * @example
 *   const result = await ghoku.generate('image-gen', {
