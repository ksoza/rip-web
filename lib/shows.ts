...
export const ART_STYLES: ArtStyle[] = [
  { id: 'source-faithful', label: 'Source Faithful', emoji: '🎯', prompt: '', description: '1:1 recreation matching the original show\'s art style' },
...
export const SHOW_PROFILES: Record<string, ShowProfile> = {
  ...
  'Breaking Bad': {
    ...
    characters: [
      ...
      { id: 'bb5', name: 'Mike Ehrmantraut', role: 'The Fixer', emoji: '🔫', visualDesc: 'older bald man, world-weary expression, plain clothes, no-nonsense demeanor', voiceDesc: 'gruff, deadpan, dry humor, minimal words, intimidating calm' },
    ],
  },
  'Game of Thrones': {
    ...
    characters: [
      ...
      { id: 'gt4', name: 'Arya Stark', role: 'No One', emoji: '🗡️', visualDesc: 'young woman with short dark hair, Needle sword, leather armor, fierce determined eyes', voiceDesc: 'Northern accent, fierce, independent, recites kill list, deadpan delivery' },
      { id: 'gt5', name: 'Cersei Lannister', role: 'The Queen', emoji: '👑', visualDesc: 'golden blonde hair, elegant royal gowns, cold regal beauty, wine glass in hand', voiceDesc: 'cold, imperious, cutting remarks, regal British accent, venomous charm' },
    ],
  },
  'The Sopranos': {
    ...
    characters: [
      { id: 'sp1', name: 'Tony Soprano', role: 'Mob Boss', emoji: '🤌', visualDesc: 'heavyset Italian-American man, dark hair, often in bathrobe or expensive suits, gold jewelry, cigar', voiceDesc: 'New Jersey Italian accent, menacing yet charismatic, switches between warm and terrifying, gravelly voice' },
      { id: 'sp2', name: 'Carmela Soprano', role: 'The Wife', emoji: '💍', visualDesc: 'well-dressed woman, gold jewelry, perfectly styled hair, suburban housewife elegance', voiceDesc: 'New Jersey accent, conflicted, sharp when angry, loving but frustrated' },
      { id: 'sp3', name: 'Christopher Moltisanti', role: 'The Protégé', emoji: '🎬', visualDesc: 'young Italian-American man, leather jacket, sharp features, often agitated', voiceDesc: 'impulsive, emotional, New Jersey accent, aspiring filmmaker talk mixed with mob speak' },
      { id: 'sp4', name: 'Dr. Melfi', role: 'The Therapist', emoji: '📋', visualDesc: 'professional woman in business attire, calm demeanor, therapy office setting', voiceDesc: 'calm, professional, analytical, slight Italian-American accent, measured responses' },
    ],
  },
  'The Wire': {
    ...
    characters: [
      { id: 'tw1', name: 'Jimmy McNulty', role: 'Rogue Detective', emoji: '🔍', visualDesc: 'disheveled white detective, loosened tie, always drinking, stubborn expression', voiceDesc: 'Baltimore accent, sarcastic, confrontational, slurred when drunk, righteous anger' },
      { id: 'tw2', name: 'Omar Little', role: 'The Robin Hood', emoji: '🎯', visualDesc: 'Black man with facial scar, duster coat, shotgun, whistling while walking', voiceDesc: 'distinctive whistle, calm before violence, Baltimore street speak, philosophical, "Omar comin"' },
      { id: 'tw3', name: 'Avon Barksdale', role: 'Drug Kingpin', emoji: '👑', visualDesc: 'muscular Black man, athletic build, expensive but understated clothing', voiceDesc: 'commanding, street authority, Baltimore accent, strategic mind' },
      { id: 'tw4', name: 'Stringer Bell', role: 'The Businessman', emoji: '📊', visualDesc: 'well-dressed Black man in suits, Robert\'s Rules book, business professional look', voiceDesc: 'educated speech mixed with street, MBA vocabulary, strategic, cold when needed' },
    ],
  },
  'Peaky Blinders': {
    ...
    characters: [
      { id: 'pb1', name: 'Thomas Shelby', role: 'Boss of the Peaky Blinders', emoji: '🎩', visualDesc: 'sharp cheekbones, ice-blue eyes, peaked flat cap with razor blade, three-piece suit, cigarette in mouth, overcoat', voiceDesc: 'quiet Birmingham accent, calculated, rarely raises voice, intense pauses, "by order of the Peaky Blinders"' },
      { id: 'pb2', name: 'Arthur Shelby', role: 'The Enforcer', emoji: '👊', visualDesc: 'rough-looking man, peaked cap, scruffy, wild eyes, often bruised or bloodied', voiceDesc: 'loud Birmingham accent, volatile, switches from rage to tears, "ARTHUR!" energy' },
      { id: 'pb3', name: 'Polly Gray', role: 'The Matriarch', emoji: '🔮', visualDesc: 'dark-haired woman, dramatic makeup, jewelry, fur coat, commanding presence', voiceDesc: 'sharp Birmingham accent, witty, fierce, spiritual undertones, protective' },
      { id: 'pb4', name: 'Alfie Solomons', role: 'Jewish Gang Leader', emoji: '🥊', visualDesc: 'large bearded man, flat cap, glasses, wild gesticulations, dusty bakery', voiceDesc: 'East London Jewish accent, rambling monologues, unpredictable, philosophical tangents' },
    ],
  },
  'Better Call Saul': {
    ...
    characters: [
      ...
      { id: 'bc2', name: 'Kim Wexler', role: 'The Partner', emoji: '📑', visualDesc: 'blonde ponytail, professional suits, determined expression, sharp and polished', voiceDesc: 'controlled, intelligent, fierce when provoked, quiet intensity, steady delivery' },
      { id: 'bc3', name: 'Nacho Varga', role: 'Double Agent', emoji: '🎭', visualDesc: 'Latino man, leather jacket, tough exterior but compassionate eyes, nervous energy', voiceDesc: 'measured, careful, street-smart, underlying fear, quiet desperation' },
      { id: 'bc4', name: 'Lalo Salamanca', role: 'Charismatic Villain', emoji: '😈', visualDesc: 'handsome Latino man, warm smile hiding danger, casual expensive clothing', voiceDesc: 'cheerful, charming, laughing, switches to terrifying in an instant, Mexican accent' },
    ],
  },
  'Ozark': {
    ...
    characters: [
      { id: 'oz1', name: 'Marty Byrde', role: 'Money Launderer', emoji: '💰', visualDesc: 'unassuming white man in business casual, glasses, constantly stressed, average build', voiceDesc: 'rapid-fire financial explanations, nervous but controlled, Midwest flat delivery, analytical' },
      { id: 'oz2', name: 'Wendy Byrde', role: 'The Ambitious Wife', emoji: '🏛️', visualDesc: 'put-together woman, increasingly powerful appearance, political ambition in her eyes', voiceDesc: 'politically savvy, manipulative warmth, escalating ruthlessness, Southern hints' },
      { id: 'oz3', name: 'Ruth Langmore', role: 'The Local', emoji: '🔥', visualDesc: 'young blonde woman, tough rural look, cutoff shorts, defiant posture', voiceDesc: 'thick Ozark accent, profanity-heavy, fierce, "I don\'t know shit about fuck", raw emotion' },
    ],
  },
  'Succession': {
    ...
    characters: [
      { id: 'su1', name: 'Logan Roy', role: 'The Patriarch', emoji: '🦁', visualDesc: 'imposing elderly white man, silver hair, dark suits, intimidating glare, conference rooms', voiceDesc: 'Scottish-American growl, "fuck off", terrifying authority, bark-like commands, unpredictable rage' },
      { id: 'su2', name: 'Kendall Roy', role: 'The Heir', emoji: '💊', visualDesc: 'nervous-looking man in expensive casual, puffer vest over suit, trying too hard to be cool', voiceDesc: 'rambling, insecure bravado, rap references, desperate approval-seeking, cringeworthy confidence' },
      { id: 'su3', name: 'Shiv Roy', role: 'The Daughter', emoji: '👩‍💼', visualDesc: 'polished redhead woman in power suits, calculated expressions, political polish', voiceDesc: 'sharp, condescending, political operative speak, British-American accent blend' },
      { id: 'su4', name: 'Roman Roy', role: 'The Youngest', emoji: '🤡', visualDesc: 'slim young man, casual expensive clothes, smirking expression, fidgety energy', voiceDesc: 'crude jokes, deflecting with humor, insecure underneath, rapid-fire quips, inappropriately funny' },
    ],
  },
  ...
  'Stranger Things': {
    ...
    characters: [
      ...
      { id: 'st3', name: 'Steve Harrington', role: 'Babysitter King', emoji: '🦇', visualDesc: 'tall with iconic fluffy hair, sailor outfit or prep clothes, bat with nails', voiceDesc: 'confident but caring, evolved from jerk to protector, sarcastic humor' },
      { id: 'st4', name: 'Vecna', role: 'The Villain', emoji: '🕰️', visualDesc: 'tall humanoid creature covered in vines and tendrils, one arm as clock hand, grotesque face', voiceDesc: 'deep, echoing, philosophical villain monologues, theatrical menace' },
      { id: 'st5', name: 'Hopper', role: 'The Chief', emoji: '🚔', visualDesc: 'large man in police chief uniform or Hawaiian shirt, mustache, gruff exterior', voiceDesc: 'gruff, protective, dad energy, yelling then tender, deep voice' },
    ],
  },
  'The Last of Us': {
    ...
    characters: [
      { id: 'tl1', name: 'Joel Miller', role: 'Smuggler / Protector', emoji: '🔨', visualDesc: 'rugged middle-aged man, flannel shirt, graying beard, weathered face, always armed', voiceDesc: 'Texas accent, gruff, emotionally guarded, few words, paternal when caring' },
      { id: 'tl2', name: 'Ellie Williams', role: 'The Immune One', emoji: '🍄', visualDesc: 'teenage girl, auburn ponytail, flannel over t-shirt, switchblade, bite scar on arm', voiceDesc: 'sarcastic teen, witty, dark humor, vulnerable underneath, "okay", determined' },
      { id: 'tl3', name: 'Tess', role: 'Joel\'s Partner', emoji: '💪', visualDesc: 'tough woman, practical survival clothing, short dark hair, no-nonsense expression', voiceDesc: 'direct, pragmatic, Boston toughness, emotionally controlled, fierce loyalty' },
    ],
  },
  'The Mandalorian': {
    ...
    characters: [
      ...
      { id: 'mn2', name: 'Grogu', role: 'The Child', emoji: '💚', visualDesc: 'tiny green alien baby, large ears, big dark eyes, brown robe, floating pod', voiceDesc: 'baby coos, giggles, occasional Force sounds, no speech, pure expression sounds' },
      { id: 'mn3', name: 'Bo-Katan', role: 'Mandalore Royalty', emoji: '👸', visualDesc: 'auburn-haired woman in blue Mandalorian armor, regal bearing, Darksaber', voiceDesc: 'commanding, regal, warrior authority, clipped military speech' },
      { id: 'mn4', name: 'Moff Gideon', role: 'Imperial Villain', emoji: '🦹', visualDesc: 'imposing Black man in Imperial officer uniform, later dark beskar armor, Darksaber', voiceDesc: 'theatrical, calculating, Imperial authority, monologue villain delivery' },
    ],
  },
  'Wednesday': {
    ...
    characters: [
      { id: 'wd1', name: 'Wednesday Addams', role: 'Nevermore Detective', emoji: '🖤', visualDesc: 'pale girl with long black braids, black dress with white collar, deadpan expression, never smiles', voiceDesc: 'monotone, dry dark humor, deadpan delivery, morbid observations, zero emotion in voice' },
      { id: 'wd2', name: 'Enid Sinclair', role: 'Bubbly Werewolf', emoji: '🐺', visualDesc: 'colorful rainbow-streaked blonde hair, bright preppy clothes, always smiling, expressive', voiceDesc: 'bubbly, enthusiastic, valley girl energy, emotional, excitable squeals' },
      { id: 'wd3', name: 'Thing', role: 'Helpful Hand', emoji: '🫳', visualDesc: 'disembodied human hand, crawls independently, expressive finger gestures', voiceDesc: 'no voice, communicates through tapping and sign language gestures' },
  ...
  'The Walking Dead': {
    ...
    characters: [
      { id: 'wk1', name: 'Rick Grimes', role: 'The Leader', emoji: '🤠', visualDesc: 'bearded man in sheriff hat, Colt Python revolver, dusty leather jacket, blood-splattered', voiceDesc: 'Southern drawl, leadership speeches, "Carl!", emotional intensity, gravel voice' },
      { id: 'wk2', name: 'Daryl Dixon', role: 'The Tracker', emoji: '🏹', visualDesc: 'scruffy man with crossbow, leather vest with angel wings, motorcycle, greasy hair', voiceDesc: 'mumbling Southern accent, minimal words, grunts, loyal, rough but caring' },
      { id: 'wk3', name: 'Negan', role: 'The Villain', emoji: '🏏', visualDesc: 'tall man in leather jacket, red scarf, Lucille (barbed wire bat), cocky lean-back pose', voiceDesc: 'theatrical, crude humor, intimidating, drawn-out words, "hot diggity dog"' },
  ...
  'Westworld': {
    ...
    characters: [
      { id: 'ww1', name: 'Dolores Abernathy', role: 'The Awakened Host', emoji: '🤖', visualDesc: 'beautiful blonde woman in blue prairie dress, innocent-looking, later armored and militant', voiceDesc: 'initially sweet and innocent, evolving to commanding and revolutionary, thoughtful monologues' },
      { id: 'ww2', name: 'Maeve Millay', role: 'The Madam', emoji: '🎭', visualDesc: 'elegant Black woman, saloon madam dress, knowing eyes, regal bearing', voiceDesc: 'British accent, witty, commanding, self-aware, sharp humor, maternal fierceness' },
      { id: 'ww3', name: 'Bernard Lowe', role: 'The Creator', emoji: '🧠', visualDesc: 'bespectacled Black man in business casual, glasses, thoughtful expression, lab environments', voiceDesc: 'calm, analytical, confused when discovering truth, gentle but determined' },
      { id: 'ww4', name: 'Man in Black', role: 'The Player', emoji: '🖤', visualDesc: 'all-black Western outfit, black hat, grizzled, menacing presence, revolver', voiceDesc: 'gravelly, world-weary, nihilistic, Western villain drawl, philosophical menace' },
    ],
  },
  'The Witcher': {
    ...
    characters: [
      ...
      { id: 'wt2', name: 'Yennefer', role: 'Sorceress of Vengerberg', emoji: '🔮', visualDesc: 'beautiful dark-haired woman in elegant black and white, violet eyes, magical purple energy', voiceDesc: 'sharp, ambitious, commanding, vulnerable underneath, powerful incantations' },
      { id: 'wt3', name: 'Ciri', role: 'The Lion Cub', emoji: '🦁', visualDesc: 'young woman with ashen blonde hair, green eyes, dirty traveling clothes becoming warrior attire', voiceDesc: 'determined, scared but brave, royal bearing emerging, fierce yells in combat' },
      { id: 'wt4', name: 'Jaskier', role: 'The Bard', emoji: '🎶', visualDesc: 'flamboyant man in colorful doublets, lute, feathered hat, always performing', voiceDesc: 'theatrical, witty, singing, dramatic, loyal friend, comic relief energy' },
    ],
  },
  'House of the Dragon': {
    ...
    characters: [
      { id: 'hd1', name: 'Rhaenyra Targaryen', role: 'The Heir', emoji: '🐉', visualDesc: 'platinum blonde Targaryen woman, regal Targaryen black and red clothing, crown, dragonrider', voiceDesc: 'regal British accent, determined, defiant, maternal fierceness, political cunning' },
      ...
      { id: 'hd3', name: 'Alicent Hightower', role: 'The Queen', emoji: '👑', visualDesc: 'auburn-haired woman in green Hightower gowns, pious expression becoming hardened, regal bearing', voiceDesc: 'measured, politically careful, increasingly bitter, pious vocabulary, steely resolve' },
    ],
  },
  ...
  'The Office': {
    ...
    characters: [
      { id: 'of1', name: 'Michael Scott', role: 'World\'s Best Boss', emoji: '🏆', visualDesc: 'middle-aged white man in ill-fitting suit, "World\'s Best Boss" mug, desperate-to-be-liked expression', voiceDesc: 'bumbling, inappropriate, "that\'s what she said", tries too hard, cringe humor, surprisingly sincere' },
      { id: 'of2', name: 'Dwight Schrute', role: 'Assistant (to the) Regional Manager', emoji: '🥬', visualDesc: 'stern man with glasses, mustard yellow shirt, beet-colored tie, rigid posture', voiceDesc: 'authoritative, robotic delivery, beet farm references, "FALSE!", survival skills obsession' },
      { id: 'of3', name: 'Jim Halpert', role: 'The Prankster', emoji: '😏', visualDesc: 'tall man with floppy hair, looking directly at camera with knowing smirk, loosened tie', voiceDesc: 'sarcastic, deadpan to camera, pranking Dwight, charming, relatable everyman' },
      { id: 'of4', name: 'Kevin Malone', role: 'Accountant / Chili Expert', emoji: '🍲', visualDesc: 'heavyset bald man, simple smile, often eating, accounting desk', voiceDesc: 'slow, simple, lovable, "nice", food obsessed, surprisingly wise occasionally' },
    ],
  },
  'Friends': {
    ...
    characters: [
      { id: 'fr1', name: 'Ross Geller', role: 'The Paleontologist', emoji: '🦕', visualDesc: 'nerdy man with gelled hair, often gesticulating about dinosaurs, khaki pants', voiceDesc: 'nasally, "WE WERE ON A BREAK!", nerdy enthusiasm, whiny, three divorces sadness' },
      { id: 'fr2', name: 'Rachel Green', role: 'The Fashionista', emoji: '👗', visualDesc: 'beautiful woman with signature hairstyle, fashionable outfits, coffee shop waitress apron', voiceDesc: 'valley girl undertones, "oh my god", fashion vocabulary, flirty, spoiled-turning-independent' },
      { id: 'fr3', name: 'Joey Tribbiani', role: 'The Actor', emoji: '🍕', visualDesc: 'handsome Italian-American man, leather jacket, big smile, pizza in hand', voiceDesc: '"How YOU doin\'?", food-obsessed, lovable dumb, acting badly, loyal friend, Italian phrases' },
      { id: 'fr4', name: 'Chandler Bing', role: 'The Funny One', emoji: '😂', visualDesc: 'average-looking man, sarcastic expressions, often gesticulating while making jokes', voiceDesc: 'sarcastic, self-deprecating, "could this BE any more...", awkward humor, defense mechanism jokes' },
    ],
  },
  'Seinfeld': {
    ...
    characters: [
      { id: 'se1', name: 'Jerry Seinfeld', role: 'The Comedian', emoji: '🎤', visualDesc: 'average-looking man in sneakers and jeans, neat apartment, on stage doing stand-up', voiceDesc: 'observational comedy delivery, "what\'s the deal with...", dry wit, judgmental, clean humor' },
      { id: 'se2', name: 'George Costanza', role: 'The Neurotic', emoji: '😤', visualDesc: 'short stocky bald man, glasses, always anxious or scheming, ill-fitting clothes', voiceDesc: 'whiny, neurotic, lying constantly, explosive frustration, "I WAS IN THE POOL!"' },
      { id: 'se3', name: 'Elaine Benes', role: 'The No-Nonsense', emoji: '💅', visualDesc: 'curly dark-haired woman, 90s fashion, big hair, distinctive pushing gesture', voiceDesc: 'assertive, "get OUT!" with shove, confident, dating disasters, dancing badly' },
      { id: 'se4', name: 'Cosmo Kramer', role: 'The Wild Card', emoji: '🤪', visualDesc: 'tall man with wild tall hair, vintage clothes, sliding into apartment door entrance', voiceDesc: 'physical comedy, wild ideas, sliding door entrance, "giddy up!", eccentric schemes' },
    ],
  },
  "It's Always Sunny": {
    ...
    characters: [
      { id: 'as1', name: 'Dennis Reynolds', role: 'The Golden God', emoji: '😎', visualDesc: 'handsome but unsettling man, preppy clothes, narcissistic expressions, DENNIS System', voiceDesc: 'narcissistic, rage building then exploding, "I AM A GOLDEN GOD!", sociopathic charm' },
      { id: 'as2', name: 'Charlie Kelly', role: 'The Wild Card', emoji: '🐀', visualDesc: 'disheveled man in green army jacket, illiterate, huffing things, eating cat food', voiceDesc: 'screaming, illiterate rants, "wild card bitches!", childlike enthusiasm, musical talent' },
      { id: 'as3', name: 'Frank Reynolds', role: 'The Dirty One', emoji: '💰', visualDesc: 'short older man, bald, often covered in something gross, rum ham', voiceDesc: 'gravelly, crude, "I started blasting!", scheming, zero moral compass' },
      { id: 'as4', name: 'Sweet Dee', role: 'The Bird', emoji: '🦅', visualDesc: 'tall blonde woman, bird-like movements when nervous, trying to be an actress', voiceDesc: 'dry heaving when nervous, desperate for validation, bird sounds, terrible acting' },
    ],
  },
  'Parks and Recreation': {
    ...
    characters: [
      { id: 'pr1', name: 'Leslie Knope', role: 'Deputy Director', emoji: '📋', visualDesc: 'enthusiastic blonde woman, pantsuits, binders and notebooks, wildly optimistic expression', voiceDesc: 'passionate, rapid-fire enthusiasm, government wonk vocabulary, "Ann Perkins!", never gives up' },
      { id: 'pr2', name: 'Ron Swanson', role: 'Woodworking Libertarian', emoji: '🥩', visualDesc: 'mustachioed man, woodworking, steak and whiskey, pyramid of greatness, stoic expression', voiceDesc: 'deep monotone, libertarian philosophy, "I know more than you", dry delivery, breakfast food passion' },
      { id: 'pr3', name: 'Andy Dwyer', role: 'Shoe-Shiner / Rockstar', emoji: '🎸', visualDesc: 'lovable scruffy man, Mouse Rat band t-shirt, falling into things, puppy energy', voiceDesc: 'dopey enthusiasm, rock star wannabe, lovable idiot, "burt macklin FBI!"' },
    ],
  },
  ...
  'Family Guy': {
    ...
    characters: [
      { id: 'fg1', name: 'Peter Griffin', role: 'Family Man', emoji: '🍺', visualDesc: 'obese white man, glasses, white shirt, green pants, round chin, always smiling dumbly', voiceDesc: 'dopey deep voice, "hehehehe" laugh, Rhode Island accent, random tangents, "oh my god who cares"' },
      { id: 'fg2', name: 'Stewie Griffin', role: 'Evil Baby Genius', emoji: '🧠', visualDesc: 'football-shaped head baby in yellow shirt and red overalls, sinister expression', voiceDesc: 'refined British accent from a baby, world domination plans, theatrical, "victory shall be mine!"' },
      { id: 'fg3', name: 'Brian Griffin', role: 'The Dog / Writer', emoji: '🐕', visualDesc: 'white anthropomorphic dog, martini glass, pretentious intellectual look', voiceDesc: 'pretentious intellectual, liberal opinions, failed writer angst, Seth MacFarlane voice' },
    ],
  },
  ...
  'Demon Slayer': {
    ...
    characters: [
      { id: 'ds1', name: 'Tanjiro Kamado', role: 'Water Breathing Slayer', emoji: '💧', visualDesc: 'burgundy hair with scar on forehead, hanafuda earrings, green and black checkered haori, nichirin sword', voiceDesc: 'kind, determined, polite even to enemies, emotional, hard-headed, smells danger' },
      { id: 'ds2', name: 'Nezuko Kamado', role: 'The Demon Sister', emoji: '🎋', visualDesc: 'pink-eyed girl with bamboo muzzle, pink kimono, demon horns and veins when fighting, shrinks to fit in box', voiceDesc: 'mostly silent with muffled sounds through bamboo, protective growls, occasional "mmph!"' },
  ...
  'Death Note': {
    ...
    characters: [
      { id: 'dn1', name: 'Light Yagami', role: 'Kira', emoji: '📓', visualDesc: 'handsome young Japanese man, neat brown hair, school uniform or suit, maniacal glowing red eyes when scheming', voiceDesc: 'calm intellectual, megalomaniac monologues, "I am justice!", increasingly unhinged laughter' },
      { id: 'dn2', name: 'L Lawliet', role: 'World\'s Greatest Detective', emoji: '🍬', visualDesc: 'pale disheveled man, wild black hair, white shirt, barefoot, crouching in chairs, eating sweets', voiceDesc: 'monotone, quirky, thumb-biting habit, brilliant deductions delivered flatly, sugar-addicted' },
      { id: 'dn3', name: 'Ryuk', role: 'The Shinigami', emoji: '🍎', visualDesc: 'tall skeletal death god, black feathered wings, bulging yellow eyes, eternal grin, loves apples', voiceDesc: 'amused, detached, deep chuckling, "humans are so interesting", apple crunching' },
    ],
  },
  'Dragon Ball Z': {
    ...
    characters: [
      { id: 'db1', name: 'Goku', role: 'Super Saiyan', emoji: '🟡', visualDesc: 'muscular man with spiky black hair (golden when Super Saiyan), orange gi, blue undershirt, flying nimbus', voiceDesc: 'cheerful, innocent, loves fighting, "KAMEHAMEHA!", hungry, pure-hearted, epic screaming during power-ups' },
      { id: 'db2', name: 'Vegeta', role: 'Prince of All Saiyans', emoji: '👑', visualDesc: 'shorter muscular man, flame-shaped black hair, blue spandex and white armor, proud scowl', voiceDesc: 'arrogant, pride-obsessed, "KAKAROT!", royal demands, grudging respect for Goku, intense' },
      { id: 'db3', name: 'Frieza', role: 'Emperor of the Universe', emoji: '👿', visualDesc: 'small white and purple alien, tail, multiple transformation forms, floating throne', voiceDesc: 'elegant, polite yet sadistic, "you may call me Lord Frieza", sinister laughter, theatrical cruelty' },
    ],
  },
  'My Hero Academia': {
    ...
    characters: [
      { id: 'mh1', name: 'Izuku Midoriya', role: 'One For All', emoji: '💚', visualDesc: 'green-haired freckled boy, green jumpsuit hero costume with hood, One For All lightning effects', voiceDesc: 'muttering analysis, crying easily, determined "SMASH!" screams, earnest, fanboy energy' },
      { id: 'mh2', name: 'Katsuki Bakugo', role: 'Explosion Hero', emoji: '💥', visualDesc: 'spiky blonde hair, angry expression, black tank top or hero costume with grenade gauntlets, explosions from palms', voiceDesc: 'angry screaming, "DIE!", aggressive, competitive, angry nicknames like "Deku"' },
      { id: 'mh3', name: 'All Might', role: 'Symbol of Peace', emoji: '💪', visualDesc: 'massive muscular blonde man in red/white/blue hero suit, dramatic shadowed eyes, huge smile (deflates to skinny form)', voiceDesc: 'booming heroic voice, "I AM HERE!", American city attack names, inspiring speeches, coughing blood in weak form' },
    ],
  },
  ...
  'The Dark Knight': {
    ...
    characters: [
      { id: 'dk1', name: 'Batman / Bruce Wayne', role: 'The Dark Knight', emoji: '🦇', visualDesc: 'black armored bat suit, cape, cowl with glowing white eyes, or billionaire in suit', voiceDesc: 'growling deep Batman voice, "I\'m Batman", Bruce Wayne charming and smooth, dual personality' },
      { id: 'dk2', name: 'Joker', role: 'Agent of Chaos', emoji: '🃏', visualDesc: 'smeared white face paint, Glasgow smile scars, green stringy hair, purple suit, nurse outfit', voiceDesc: 'lip-licking, "why so serious?", chaotic laughter, multiple scar stories, unsettling calm' },
      { id: 'dk3', name: 'Harvey Dent', role: 'Two-Face', emoji: '🪙', visualDesc: 'handsome DA in suit becoming half-burned face, coin flipper, split personality visual', voiceDesc: 'righteous prosecutor becoming nihilistic, "you either die a hero...", coin flip decisions' },
    ],
  },
  'Avengers: Endgame': {
    ...
    characters: [
      { id: 'ae1', name: 'Tony Stark', role: 'Iron Man', emoji: '🤖', visualDesc: 'goateed man in red and gold Iron Man armor, arc reactor glowing, or casual genius billionaire', voiceDesc: 'quippy, sarcastic genius, "I am Iron Man", rapid-fire humor, emotional depth underneath' },
      { id: 'ae2', name: 'Steve Rogers', role: 'Captain America', emoji: '🛡️', visualDesc: 'muscular blonde man in star-spangled uniform, vibranium shield, or bearded in Nomad look', voiceDesc: 'inspirational leader, "I can do this all day", old-fashioned values, Brooklyn accent hints' },
      ...
      { id: 'ae4', name: 'Thanos', role: 'The Mad Titan', emoji: '💜', visualDesc: 'massive purple-skinned titan, gold armor, Infinity Gauntlet with glowing stones, chin grooves', voiceDesc: 'philosophical, calm conviction, "I am inevitable", deep resonant voice, believes he\'s right' },
    ],
  },
  'Spider-Verse': {
    ...
    characters: [
      { id: 'sv1', name: 'Miles Morales', role: 'Spider-Man', emoji: '🕷️', visualDesc: 'Black-Latino teen, black and red Spider suit with graffiti hoodie, street art style, Brooklyn', voiceDesc: 'teenage confidence growing, Brooklyn slang, bilingual English-Spanish, "hey", finding his voice' },
      { id: 'sv2', name: 'Gwen Stacy', role: 'Spider-Gwen', emoji: '🩰', visualDesc: 'blonde with pink undercut, white and pink Spider suit, ballet shoes, watercolor aesthetic', voiceDesc: 'dry wit, emotionally guarded, punk rock energy, vulnerable underneath cool exterior' },
      { id: 'sv3', name: 'Miguel O\'Hara', role: 'Spider-Man 2099', emoji: '🔴', visualDesc: 'tall muscular Latino man, blue and red futuristic suit, vampire-like fangs, holographic tech', voiceDesc: 'intense, frustrated authority figure, trying to control the multiverse, barely contained rage' },
    ],
  },
  'The Matrix': {
    ...
    characters: [
      { id: 'mx1', name: 'Neo', role: 'The One', emoji: '💊', visualDesc: 'man in long black coat, sunglasses, bullet-dodging pose, flowing trenchcoat, green code reflection', voiceDesc: 'quiet, evolving from confused to enlightened, "I know kung fu", "whoa", messianic calm' },
      { id: 'mx2', name: 'Morpheus', role: 'The Guide', emoji: '🕶️', visualDesc: 'bald Black man in long leather coat, small sunglasses, martial arts stance, Nebuchadnezzar ship', voiceDesc: 'philosophical, measured delivery, "what if I told you...", prophetic conviction, deep voice' },
      { id: 'mx3', name: 'Agent Smith', role: 'The System', emoji: '🤵', visualDesc: 'man in identical black suit, earpiece, sunglasses, multiplying copies, cold expression', voiceDesc: 'monotone contempt, "Mr. Anderson...", virus-like repetition, growing emotional despite himself' },
    ],
  },
  'Pulp Fiction': {
    ...
    characters: [
      { id: 'pf1', name: 'Vincent Vega', role: 'Hitman', emoji: '💈', visualDesc: 'long black hair, bolo tie, black suit, dancing, heroin-addled, reading on toilet', voiceDesc: 'cool, casual about violence, European travel stories, Travolta swagger' },
      { id: 'pf2', name: 'Jules Winnfield', role: 'The Philosophical Hitman', emoji: '🍔', visualDesc: 'Black man with jheri curl, black suit, quoting Bible before killing, intense eyes', voiceDesc: 'Ezekiel 25:17 recital, philosophical, "say what again!", intense delivery, finding enlightenment' },
      { id: 'pf3', name: 'Mia Wallace', role: 'The Boss\'s Wife', emoji: '💃', visualDesc: 'dark bob haircut, white shirt, black pants, twist dancing, painting nails, smoking', voiceDesc: 'cool, flirtatious, "don\'t be a square", dangerous charm, OD scene intensity' },
    ],
  },
  'The Godfather': {
    ...
    characters: [
      { id: 'gf1', name: 'Vito Corleone', role: 'The Godfather', emoji: '🌹', visualDesc: 'older Italian man in tuxedo, rose in lapel, cat on lap, cotton-stuffed cheeks, office shadows', voiceDesc: 'raspy whisper, "I\'m gonna make him an offer he can\'t refuse", gentle menace, old-world respect' },
      { id: 'gf2', name: 'Michael Corleone', role: 'The Heir', emoji: '🔫', visualDesc: 'young Italian-American man, military uniform then dark suits, cold eyes, transformation to don', voiceDesc: 'quiet, controlled, increasingly cold, "it\'s not personal, it\'s strictly business"' },
      { id: 'gf3', name: 'Sonny Corleone', role: 'The Hotheaded Son', emoji: '💢', visualDesc: 'tough Italian-American man, open shirt, aggressive posture, tollbooth scene', voiceDesc: 'explosive temper, loud Italian-American accent, protective, impulsive, passionate' },
    ],
  },
  'John Wick': {
    ...
    characters: [
      { id: 'jw1', name: 'John Wick', role: 'Baba Yaga', emoji: '🐶', visualDesc: 'tall dark-haired man in black suit, tactical vest, multiple weapons, beard, focused killer expression', voiceDesc: 'minimal words, "yeah", intense focus, grief-driven, Russian-accented past, precise' },
      { id: 'jw2', name: 'Winston', role: 'Continental Manager', emoji: '🎩', visualDesc: 'elegant older man in three-piece suit, Continental lobby, sophisticated demeanor', voiceDesc: 'refined, rules-obsessed, "Jonathan", elegant menace, diplomatic, British gravitas' },
      { id: 'jw3', name: 'Bowery King', role: 'Underground Leader', emoji: '🕊️', visualDesc: 'charismatic Black man in street royalty clothing, pigeons, underground network, smiling menace', voiceDesc: 'theatrical, street preacher energy, pigeon metaphors, dramatic delivery, unpredictable loyalty' },
    ],
  },
  'Inception': {
    ...
    characters: [
      { id: 'ic1', name: 'Dom Cobb', role: 'The Extractor', emoji: '🎡', visualDesc: 'handsome man in suit, spinning top totem, architectural dreamscapes, haunted expression', voiceDesc: 'intense, driven by guilt, explaining dream mechanics, "we need to go deeper"' },
      { id: 'ic2', name: 'Arthur', role: 'The Point Man', emoji: '🎯', visualDesc: 'well-dressed man in vest and tie, zero-gravity fighting, precise and organized', voiceDesc: 'professional, dry wit, "you mustn\'t be afraid to dream a little bigger darling" energy' },
      { id: 'ic3', name: 'Mal', role: 'The Shade', emoji: '💀', visualDesc: 'beautiful French woman, appearing in dreams unexpectedly, tragic figure, elegant and dangerous', voiceDesc: 'French accent, haunting, "you\'re waiting for a train...", seductive and dangerous' },
    ],
  },
  'Interstellar': {
    ...
    characters: [
      { id: 'is1', name: 'Cooper', role: 'The Pilot', emoji: '🚀', visualDesc: 'rugged man in flight suit or farmer clothes, corn fields, spaceship cockpit, emotional father', voiceDesc: 'Southern warmth, pilot jargon, crying about his kids, "MURPH!", determination through tears' },
      { id: 'is2', name: 'Dr. Brand', role: 'The Scientist', emoji: '🔬', visualDesc: 'intelligent woman in space suit, on alien planets, driven expression, scientific equipment', voiceDesc: 'passionate about love transcending dimensions, scientific but emotional, poetry about love' },
      { id: 'is3', name: 'TARS', role: 'The Robot', emoji: '🤖', visualDesc: 'rectangular monolith robot, walking on articulated legs, military design, practical look', voiceDesc: 'dry humor set to 75%, military background, surprisingly funny, loyal, "knock knock"' },
    ],
  },
  'Star Wars': {
    ...
    characters: [
      ...
      { id: 'sw2', name: 'Darth Vader', role: 'The Dark Lord', emoji: '🖤', visualDesc: 'towering black armor, cape, iconic helmet and mask, red lightsaber, breathing apparatus', voiceDesc: 'deep mechanized breathing, James Earl Jones bass, "I am your father", terrifying authority' },
      { id: 'sw3', name: 'Han Solo', role: 'The Smuggler', emoji: '🔫', visualDesc: 'scruffy-looking man in vest, blaster holster, Millennium Falcon pilot, cocky grin', voiceDesc: 'cocky, "I know", shoots first, reluctant hero, sarcastic charm, "never tell me the odds"' },
      { id: 'sw4', name: 'Princess Leia', role: 'Rebel Leader', emoji: '👸', visualDesc: 'woman in white robe with iconic hair buns, later general uniform, blaster, commanding presence', voiceDesc: 'sharp-tongued, commanding, "help me Obi-Wan", political leader voice, takes no nonsense' },
    ],
  },
