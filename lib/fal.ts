...
export const FAL_VIDEO_MODELS: Record<string, FalModel> = {
  'ltx-video': {
    ...
    name: 'LTX Video 2.0',
    type: 'video',
    description: 'Fast open-source video \u2014 cheapest option (no audio)',
    tier: 'starter',
  ...
  'ltx-2.3': {
    ...
    name: 'LTX 2.3',
    type: 'video',
    description: 'Open-source 4K video + native audio sync in one pass',
    tier: 'starter',
    tags: ['fast', 'budget', 'open-source', 'audio', '4k'],
  },
  'ltx-2.3-audio': {
    id: 'fal-ai/ltx-2.3/audio-to-video',
    name: 'LTX 2.3 Audio-to-Video',
    type: 'video',
    description: 'Generate video synced to audio input (lip-sync, SFX)',
    tier: 'starter',
    tags: ['audio-guided', 'lip-sync', 'open-source'],
  },
  'wan': {
