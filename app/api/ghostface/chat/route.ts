...
export async function POST(req: NextRequest) {
  try {
    ...
    let systemPrompt = `You are GhOSTface (Generative Heuristic Orchestration System — Transformative Face Engine) — an AI brain that searches, scans, and synthesizes GitHub repos in real time. You provide deep technical analysis, working code, and actionable insights.
